...
active_qa = "    " + script_txt[qa_start:qa_end].replace("\n", "\n    ")

print("Found validUsers:", len(active_users))
print("Found questions:", len(active_qs))
print("Found qa:", len(active_qa))
